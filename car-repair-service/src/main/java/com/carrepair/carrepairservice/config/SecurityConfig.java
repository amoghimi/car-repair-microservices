package com.carrepair.carrepairservice.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/hello").hasAnyRole("ADMIN", "SERVICE_ADVISOR", "CUSTOMER")
                        .requestMatchers("/repairs/**").hasAnyRole("ADMIN", "SERVICE_ADVISOR")
