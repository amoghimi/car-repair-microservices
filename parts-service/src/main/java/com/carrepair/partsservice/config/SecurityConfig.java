package com.carrepair.partsservice.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/parts").hasAnyRole("ADMIN", "SERVICE_ADVISOR", "CUSTOMER")
                        .requestMatchers("/parts/buy").hasAnyRole("ADMIN", "CUSTOMER")
